...
/**
 * Парсер новостей с сайта http://vestiregion.ru/
 */
class VestiRegionRuParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    const SITE_URL = 'http://vestiregion.ru';
    ...
    public function parse(): array
    {
        ...
        foreach ($newsList as $newsItem) {
            ...
            $newContentCrawler = $newsCrawler->filterXPath("//div[@itemprop='articleBody']");
