...
/**
 * Парсер новостей с сайта https://kosmos-x.net.ru/
 */
class KosmosXnetRuParser implements ParserInterface
{
    const USER_ID = 2;
    const FEED_ID = 2;
    const SITE_URL = 'https://kosmos-x.net.ru';
    ...
    public function parse(): array
    {
        ...
        $urlNews = self::SITE_URL . '/news/rss/';
        ...
        foreach ($newsList as $newsItem) {
            ...
            $newContentCrawler = $newsCrawler->filterXPath("//div[@class='Message']");
